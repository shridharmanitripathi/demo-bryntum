...
<template>
    <div id="app">
        <demo-header
            ...
            link='../../../../#example-vue-javascript-pdf-export'
        ></demo-header>
        ...
        <scheduler
            ...
            :pdfExportFeature    = "schedulerConfig.pdfExportFeature"
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            exportHandler() {
                this.$refs.scheduler.schedulerInstance.features.pdfExport.showExportDialog();
            }
        },

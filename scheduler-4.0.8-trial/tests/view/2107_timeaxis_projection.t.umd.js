StartTest(function (t) {
  ...
  PresetManager.registerPreset('test', {
    ...
    headers: [{
      ...
      headerCellCls: 'foo',
      align: 'end',
      renderer: function renderer(start, end, cellData, i, store) {
        if (i === 0) {
  ...
  t.it('Should project dates correctly in horizontal mode', function (t) {
    var timeaxisStartX = 0; //scheduler.timeAxisColumn.element.offsetLeft, // defaulting to local coordinates
  ...
  t.it('Should support unit, dateFormat, renderer, headerCellCls config', function (t) {

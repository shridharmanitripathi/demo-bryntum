import { AjaxTransport, AbstractCrudManager, CrudManager, AjaxHelper, ProjectModel } from '../../build/scheduler.module.js?447702';
...
StartTest(t => {
    ...
    t.it('Should throw if trying to load without a URL', async t => {
        ...
        await crud.load().catch(e => t.is(e.message, 'Trying to request without URL specified'));
        ...
        await crudWithRequestConfig.load();

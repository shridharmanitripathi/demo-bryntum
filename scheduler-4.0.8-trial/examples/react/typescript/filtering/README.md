## Filtering Scheduler React + TypeScript demo

This example shows how to use Bryntum Scheduler and Widget wrappers that allow Bryntum components to behave like native React components. There are two input field widgets, one for filtering and one for highlighting the scheduler tasks. These fields are bound to the React App that executes filtering and highlighting itself.

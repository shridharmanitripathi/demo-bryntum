...
StartTest(t => {
    ...
    t.it('Should trigger scroll manager of currently hovered scheduler', async t => {
        ...
        t.chain(
            ...
            { waitFor : () => horizontal2.x === horizontal2.maxX && vertical2.y === vertical2.maxY },
            ...
            { waitFor : () => horizontal1.x === horizontal1.maxX && vertical1.y === vertical1.maxY },
    ...
    t.it('Should trigger scroll manager of source scheduler', async t => {
        ...
        t.chain(
            ...
            { waitFor : () => scheduler.subGrids.normal.scrollable.x === scheduler.subGrids.normal.scrollable.maxX && scheduler.scrollable.y === scheduler.scrollable.maxY },
    ...
    t.it('Should support drag to a new scheduler and back', async t => {
        ...
        t.chain(
            ...
            {
                waitFor : () => scheduler2.subGrids.normal.scrollable.x === scheduler2.subGrids.normal.scrollable.maxX &&
                    scheduler2.scrollable.y === scheduler2.scrollable.maxY
            },
    ...
    t.it('Should constrain dragging to the union of all partnered Schedulers', async t => {
        ...
        t.chain(
            ...
            { waitFor : () => !scheduler2.timeAxisSubGrid.isScrolling },

import { LocaleManager, Localizable, AsyncHelper, AjaxHelper, DomHelper, Button, Popup, Tooltip, Toast, Widget, BrowserHelper, EventHelper, ResizeHelper, VersionHelper, DataGenerator, Fullscreen, Events, GlobalEvents, Rectangle } from '../../build/scheduler.module.js?447702';
// Load localization
...
const
    ...
    productName          = 'scheduler', // PRODUCT NAME (DON'T CHANGE OR REMOVE !!!)
    ...
    isModule             = pathName.endsWith('module.html') || (moduleTag && moduleTag.src.includes('app.module.js?447702')) || (pathName.endsWith('index.html') && isOnline),
...
class CodeEditor extends Popup {
            ...
            tbar : [
                {
                    ...
                    ref      : 'filesCombo',
                    editable : false,
                    value    : isModule ? 'app.module.js?447702' : isUmd ? 'app.umd.js?447702' : 'app.js?447702',
                    items    : [
                        isModule ? 'app.module.js?447702' : isUmd ? 'app.umd.js?447702' : 'app.js?447702'
                    ],
    ...
    async loadCode(filename = isModule ? 'app.module.js?447702' : isUmd ? 'app.umd.js?447702' : 'app.js?447702') {
        const
            me = this;
        ...
        if (filename.endsWith('.js?447702')) {
            me.mode = 'js';
            code = me.processJS(code);
        }
        else if (filename.endsWith('.css?447702')) {
            me.mode = 'css';
    ...
    updateDownloadLink() {
        ...
        downloadLink.href = `data:text/${this.filename.endsWith('.css?447702') ? 'css' : 'javascript'};charset=utf-8,${escape(this.codeElement.innerText)}`;
    }
    ...
    static async addToPage(button) {
        ...
        if (document.head.querySelector('[href$="app.css?447702"]')) {
            filesStore.add({
                text  : 'resources/app.css?447702',
                value : 'resources/app.css?447702'
            });
        }

## Dependencies React demo
This example shows how you can have dependencies visualized between tasks by loading data using the CrudManager in the React app.

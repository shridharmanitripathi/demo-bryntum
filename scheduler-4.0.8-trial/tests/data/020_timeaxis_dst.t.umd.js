StartTest(function (t) {
  var dstDates = t.getDSTDates(2018); // This test requires DST dates to be present!

  if (!dstDates.length) return;
  t.it('roundDate', function (t) {
    var dstDate, d, i; // Test each DST change
      ...
      for (i = 1; i <= 60; i++) {
        ...
        (function (dstDate, i) {
          t.it('DST: ' + dstDate.toLocaleDateString() + '; Unit: SECONDS; Resolution: ' + i + ';', function (t) {
            t.isDate(dstDate);
            var startTA = DateHelper.clearTime(DateHelper.add(dstDate, -1, 'week')),
            ...
            var result = ta.roundDate(rawDate);

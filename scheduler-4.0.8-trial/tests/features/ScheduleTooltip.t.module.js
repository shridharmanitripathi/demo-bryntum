...
StartTest(t => {
    ...
    t.it('Should be displayed when hovering empty area', t => {
        t.chain(
    ...
    t.it('Should not be displayed when hovering event', t => {
        t.chain(
            { moveMouseTo : [0, 0] },
    ...
    t.it('Should not be displayed when dragging an event', t => {
        t.chain(
    ...
    t.it('Should still be displayed when scheduler is readOnly', t => {
    ...
    t.it('Clock template should respect time axis resolution', t => {

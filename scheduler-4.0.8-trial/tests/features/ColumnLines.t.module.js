import { Scheduler, PresetManager } from '../../build/scheduler.module.js?447702';
...
StartTest(t => {
    ...
    t.it('Column lines appear properly (zooming)', t => {
    ...
    t.it('Should keep showing the bold ticks when working time is applied for week days', t => {

...
This example shows how to configure tree-like parent-child relationship between resources and tasks. The demo implements also the custom resource editor.

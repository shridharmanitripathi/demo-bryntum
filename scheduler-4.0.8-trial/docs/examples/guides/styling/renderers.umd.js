var scheduler = new Scheduler({
  ...
  viewPreset: {
    ...
    headers: [{
      ...
      unit: 'day',
      renderer: function renderer(start, end, headerConfig, index) {
        if (start.getDay() === 1) {
  ...
  columns: [{
    ...
    renderer: function renderer(_ref2) {
      var record = _ref2.record,
          value = _ref2.value;
      return "<i class=\"b-fa b-fa-".concat(record.gender, "\"></i>").concat(value);
    }
  }],
  resources: [{
    id: 1,

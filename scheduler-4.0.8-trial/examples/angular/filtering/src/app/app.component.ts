...
import { DateField, DateHelper, DomClassList } from 'bryntum-scheduler/scheduler.lite.umd.js';
...
export class AppComponent implements AfterViewInit {
    ...
    filterEvents(value) {
        ...
        this.scheduler.schedulerInstance.eventStore.filter({
    ...
    highlightEvents(value) {
        this.scheduler.schedulerInstance.eventStore.forEach(task => {
        ...
        this.scheduler.schedulerInstance.element.classList[value.length > 0 ? 'add' : 'remove']('b-highlighting');
    }

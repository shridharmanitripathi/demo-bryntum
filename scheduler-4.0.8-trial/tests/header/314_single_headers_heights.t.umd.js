StartTest(function (t) {
  PresetManager.registerPreset('dayNightShift', {
    ...
    headers: [{
      ...
      unit: 'hour',
      increment: 12,
      renderer: function renderer(startDate, endDate, headerConfig) {
  ...
  var normalHeaderEl = document.querySelector('.b-grid-headers-normal'),
  ...
  t.todo('Not the current behaviour, worth considering', function (t) {

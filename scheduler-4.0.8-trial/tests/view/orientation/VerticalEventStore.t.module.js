import { EventStore, Rectangle } from '../../../build/scheduler.module.js?447702';
...
StartTest(t => {
    ...
    t.it('CRUD - Add', async t => {
        ...
        await t.firesOk({
            observable : scheduler,
            events     : {
                renderEvent  : 1, // TODO: Should be 0
                releaseEvent : 0
            },
            async during() {
                eventStore.add({
    ...
    t.it('CRUD - Replace', async t => {
        await t.firesOk({
            observable : scheduler,
            events     : {
                renderEvent  : '<=3', // Event 2 rerenders, Event 1 changes resource, Event 1 moves in time

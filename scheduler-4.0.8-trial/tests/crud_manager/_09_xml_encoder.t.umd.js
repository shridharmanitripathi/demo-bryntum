...
StartTest(function (t) {
  ...
  var initTestData = function initTestData() {
    ...
    added2 = someStore2.getNodeById(3).appendChild({
      f1: '<>&"55',
      f2: '5<>&"55'
    });
  };
  ...
  var checkField = function checkField(t, node, record) {
  ...
  t.it('Correctly decodes load response', function (t) {
    ...
    var checkPackage = function checkPackage(t) {

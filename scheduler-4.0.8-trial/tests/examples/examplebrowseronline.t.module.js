StartTest(t => {
    ...
    t.it('Check tooltips for examples available online', t => {
        t.chain(
            ...
            { waitForSelector : '#b-example-ionic-ionic-4 i.b-fa-info', desc : 'Correct info icon used' },
    ...
    t.it('Check tooltips for examples not available online', t => {
        t.chain(
            ...
            { waitForSelector : '#b-example-custom-build i.b-fa-cog', desc : 'Correct info icon used' },

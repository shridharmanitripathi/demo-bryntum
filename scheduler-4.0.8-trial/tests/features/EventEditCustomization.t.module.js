StartTest(t => {
    ...
    t.describe('legacy customization', t => {
        ...
        t.it('Specifying listeners for event editor should not break drag create feature and tooltip', async t => {
            ...
            // failed to check that this function is called with isCalledOnce, used `counter` instead
        ...
        t.it('Changing eventType should toggle fields', async t => {
            ...
            t.chain(
                ...
                { type : 'Meeting[ENTER]', target : '.event-type input', clearExisting : true },
                ...
                { type : 'Shazam[ENTER]', target : '.event-type input', clearExisting : true },

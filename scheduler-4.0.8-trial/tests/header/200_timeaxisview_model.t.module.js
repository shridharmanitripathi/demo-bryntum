import { PresetManager, TimeAxisViewModel, TimeAxis, DateHelper } from '../../build/scheduler.module.js?447702';
...
StartTest(t => {
    t.it('forceFit and columns need to be fitted, weekAndDayLetter', t => {
        ...
        let colCfg = viewModel.columnConfig;
    ...
    t.it('no forceFit but snap and the columns do not consume the available width => they should grow', t => {
        ...
        // 1440 mins per day / 15 min increment => 96 ticks per day so minimum width for a day cell is 96 pixels to be able to support snap

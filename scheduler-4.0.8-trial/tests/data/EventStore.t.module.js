import { ObjectHelper, Model, EventStore, ResourceStore, AssignmentStore, EventModel, ProjectModel } from '../../build/scheduler.module.js?447702';
...
StartTest(t => {
    ...
    t.it('reapplyFilterOnAdd : false should work with getEvents API', async t => {
        ...
        // Programatically reapply same filter set
        eventStore.filter();

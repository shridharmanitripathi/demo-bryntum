import { Scheduler, DateHelper, BrowserHelper, VersionHelper } from '../../build/scheduler.module.js?447702';
...
StartTest(t => {
    ...
    t.it('Should open context menu when clicking outside of rows', async t => {
        scheduler = await t.getSchedulerAsync({
            features : {
                scheduleMenu : true,
                eventEdit    : false

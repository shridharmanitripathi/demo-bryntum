...
This example shows how to control animations and manipulate Scheduler events from Angular application. It uses Bryntum button and slider components that has been wrapped for Angular so they behave as any other Angular components.

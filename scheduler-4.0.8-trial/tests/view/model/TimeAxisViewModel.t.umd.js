StartTest(function (t) {
  t.it('getDateFromPosition with excluded days', function (t) {
    var viewPreset = 'weekAndMonth';
    ...
    t.it('Exclude Sun & sat', function (t) {
      ...
      t.is(model.getDateFromPosition(315), new Date(2019, 1, 8, 12), 'Correct scaled date at 315'); // TODO: Decide if part of first "tick" or second
      ...
      t.is(model.getDateFromPosition(630), new Date(2019, 1, 15), 'Correct scaled date at 630'); // Related to TODO above
      //t.is(model.getDateFromPosition(700), new Date(2019, 1, 16), 'Correct scaled date at 700');
    });
    t.it('Exclude sun', function (t) {
    ...
    t.it('Exclude sun, mon, sat', function (t) {
      timeAxis.include = null;
    ...
    t.it('Exclude thu, fri, sat', function (t) {
      timeAxis.include = null;
      model.update(560); // 4 & 7
  ...
  t.it('getDateFromPosition with excluded hours', function (t) {
    var viewPreset = 'weekAndMonth';
    var timeAxis = new TimeAxis({
      startDate: new Date(2019, 1, 3),
  ...
  t.it('getDateFromPosition with excluded days and hours', function (t) {
    var viewPreset = 'weekAndMonth';
    var timeAxis = new TimeAxis({
      startDate: new Date(2019, 1, 3),
      endDate: new Date(2019, 1, 10),
  ...
  t.it('Should respect increment value on middle header row using same unit as bottom row', function (t) {
    ...
    var count = 0;
    model.forEachInterval(0, function (startDate, endDate, index) {
      count++;
  ...
  t.it('getDateFromPosition with long month bases axis', function (t) {
    var viewPreset = {
      timeResolution: {
        unit: 'month',
        increment: 1
    ...
    timeAxis.forEach(function (tick, i) {

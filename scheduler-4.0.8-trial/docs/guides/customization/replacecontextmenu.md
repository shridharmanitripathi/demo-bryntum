...
(see the ["Customize context menus"](#guides/customization/contextmenu.md) guide) or replace them entirely.
...
<img src="resources/images/custom-event-menu.png" alt="Custom Event menu"/>

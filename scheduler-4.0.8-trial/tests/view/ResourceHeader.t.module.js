import { Rectangle, DomHelper, EventHelper } from '../../build/scheduler.module.js?447702';
    ...
    t.it('Should not instantly reload images with invalid resourceImagePath or defaultResourceImageName', async t => {
        ...
        const checkResourceImages = (resourceImagePath, defaultResourceImageName, resourceImageExtension, resourceName, checkImageName, checkErrorCount) => [
            async() => {
                ...
                t.diag(`path="${resourceImagePath}" default="${defaultResourceImageName}" extension="${resourceImageExtension}" name="${resourceName}" => ${checkErrorCount} error(s)`);
            },
            ...
            {
                waitFor : () => errorCount === checkErrorCount,
                desc    : `Expected amount of errors = ${checkErrorCount}`
            },

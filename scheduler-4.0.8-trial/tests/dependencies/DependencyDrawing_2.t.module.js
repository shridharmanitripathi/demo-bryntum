import { DomHelper, DependencyStore, Scheduler, ProjectModel, ArrayHelper } from '../../build/scheduler.module.js?447702';
...
StartTest(t => {
    ...
    t.it('Should draw dependency line if dependency dates are outside of the view', t => {
        ...
        t.chain(
            ...
            next => {
                DomHelper.forEachSelector(dependencySelector, el => {

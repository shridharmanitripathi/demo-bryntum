import { BrowserHelper } from '../../build/scheduler.module.js?447702';
    ...
    t.it('Should deselect events on drag without Ctrl', async t => {
        ...
        t.chain(
            ...
            () => {
                ...
                t.isDeeply(scheduler.selectedEvents.map(e => e.id), [3, 2], 'Selection is unaffected by draggong a non-selected event');
            }
        );
    });

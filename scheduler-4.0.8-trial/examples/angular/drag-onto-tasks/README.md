# Drag Onto Tasks demo

This example shows how to configure Grid and Scheduler on one page and how to drag equipment from the grid to scheduler.

Mind please that Grid is licensed separately

import { EventStore, ResourceStore, CrudManager, Scheduler, Base } from '../../../build/scheduler.module.js?447702';
...
StartTest(t => {
    ...
    t.xit('Recurring event occurrences are generated properly on CrudManager load', async t => {
    ...
    // TODO: uncomment (xit -> it) this when fixing https://github.com/bryntum/bryntum-suite/issues/1158
    // Error is thrown "Duplicate listener added: CrudManager#onCrudStoreChange"
    t.xit('Recurring event occurrences are generated properly if CrudManager is loaded before panels creation', async t => {

const
    ...
    isTrial = BryntumTestHelper.isTrial;
...
function getItems(mode) {
    ...
    if (isTrial) {
        ...
        frameworks.push(
            'angular/angular-1',
            //'angular/angular-2', (this demo is not built on trial)
            'angular/angular-4',
            'angular/angular-5',
            'angular/angular-6',
            {
        ...
        items = [
            {
                ...
                items : [
                    ...
                    'crud_manager/14_promise_reject.t.js',
                ...
                items : [
                    ...
                    'dependencies/228_create.t.js',
                    'dependencies/229_scheduler_events.t.js',
                    'dependencies/230_terminals.t.js',
                ...
                items          : [
                    {
                        ...
                        items : frameworks.filter(framework => framework.pageUrl != null && framework.url != null)
                    },
                    {
...
// Don't test es6 and module in IE11 and Edge

import { Scheduler, TimeAxisColumn, DateHelper, BrowserHelper, VersionHelper } from '../../build/scheduler.module.js?447702';
    ...
    t.it('LEGACY: Add event should work with EventEdit', async t => {
        ...
        t.chain(
            ...
            () => {
                ...
                t.expect(spy).toHaveBeenCalledWith('Scheduler', '5.0.0', '`ScheduleContextMenu` feature is deprecated, in favor of `ScheduleMenu` feature. Please see https://bryntum.com/docs/scheduler/#guides/upgrades/3.1.0.md for more information.');
            }
        );
    });

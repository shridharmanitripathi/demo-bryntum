import { Scheduler, CSSHelper, Rectangle } from '../../../build/scheduler.module.js?447702';
...
StartTest(t => {
    ...
    t.it('fillTicks should make all event widths multipliers of tickSize', async t => {
        ...
        t.ok(elements.every(element => element.offsetWidth === scheduler.tickSize), 'All events have correct width');
    });

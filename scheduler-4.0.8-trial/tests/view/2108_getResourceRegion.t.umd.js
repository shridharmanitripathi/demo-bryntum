StartTest(function (t) {
  ...
  t.it('HORIZONTAL getResourceRegion', function (t) {
    ...
    var column = scheduler.timeAxisColumn,
  ...
  t.xit('VERTICAL getResourceRegion', function (t) {
    scheduler = t.getScheduler({
      viewPreset: 'dayAndWeek',
      mode: 'vertical',
      startDate: new Date(2010, 0, 1),
  ...
  t.it('HORIZONTAL getScheduleRegion', function (t) {
    ...
    var region = scheduler.getScheduleRegion(null, null, false),
  ...
  t.xit('VERTICAL getScheduleRegion', function (t) {
    scheduler = t.getScheduler({
      viewPreset: 'dayAndWeek',
      mode: 'vertical',
      startDate: new Date(2010, 0, 1),

...
This example shows how to use a Grid and Scheduler on one page and drag tasks from the Grid where they are "unplanned" to the scheduler.

Mind please that the Grid is licensed separately.

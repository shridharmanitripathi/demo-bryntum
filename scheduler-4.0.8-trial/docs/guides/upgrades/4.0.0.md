...
That will cause that event to be inserted into the store as a concrete event definition, firing an [add](#Scheduler/data/EventStore#event-add) event as would

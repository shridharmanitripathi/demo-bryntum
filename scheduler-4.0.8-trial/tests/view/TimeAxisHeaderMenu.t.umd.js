StartTest(function (t) {
  ...
  t.beforeEach(function () {
    ...
    today = DateHelper.clearTime(new Date()); // After scheduler destroy, all menuitems must also have been destroyed
  ...
  t.it('Should show/hide current time line', function (t) {
    t.chain({
  ...
  t.it('Should show zoom picker', function (t) {
    t.chain({
      contextmenu: '.b-sch-header-timeaxis-cell'
    }, {
  ...
  t.it('Should change start/end date', function (t) {
  ...
  t.it('Should shift by one day even if picker submenu was shown and hidden few times', function (t) {
    var originalStart = scheduler.startDate,
        originalEnd = scheduler.endDate;
  ...
  t.it('Should filter events once', function (t) {

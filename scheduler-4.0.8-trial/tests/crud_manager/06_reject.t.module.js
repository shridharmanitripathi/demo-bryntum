import { Store, CrudManager } from '../../build/scheduler.module.js?447702';

StartTest(t => {
    // Here we test reject() method of CrudManager class
    ...
    t.it('reject() cleans up all dirty records', t => {
        const
            crud          = initTestData(),
        ...
        t.is(someStore2.allCount, 4, 'someStore2: proper number of records');
    });
});

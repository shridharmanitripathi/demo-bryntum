import { TimeSpanRecordContextMenuBase, VersionHelper, GridFeatureManager } from '../../build/scheduler.module.js?447702';
    ...
    t.it('LEGACY: Sanity', t => {
        ...
        t.chain(
            ...
            () => {
                ...
                t.expect(spy).toHaveBeenCalledWith('Scheduler', '5.0.0', '`TimeSpanRecordContextMenuBase` feature is deprecated, in favor of `TimeSpanMenuBase` feature. Please see https://bryntum.com/docs/scheduler/#guides/upgrades/3.1.0.md for more information.');
            }
        );
    });
});

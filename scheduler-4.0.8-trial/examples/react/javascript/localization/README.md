...
This example show how to use native Bryntum Scheduler localization system together with the i18next localization library. 

This example demonstrates how to use Bryntum Scheduler without the React wrapper. 
